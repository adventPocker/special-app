          ...
          <div className="w-full max-w-[158px]  md:min-w-[302px] min-h-[119px] md:min-h-[400px] h-full md:max-h-[400px] md:max-w-[440px]   ">
            <Link href={`/projects/${data.attributes.slug}`}>
              <Image
                ...
                alt="film image"
                className="lg:rounded-[80px] object-cover md:min-w-[302px] max-w-[158px]  min-h-[119px] max-h-[400px] md:max-w-[440px] w-full h-full rounded-[20px]  duration-500 transform transition group-hover:scale-105"
                width={362}
                height={119}
                loading="eager"
              />
