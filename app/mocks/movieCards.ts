...
export const mockMovieCardData: ApiFilmCard = {
  data: [
    {
      id: 1,
      attributes: {
        ...
        Country: "India",
        Language: "Malayalam",
        Distribution: "Sree Gokulam Movies ",
        ProductionsCompany: "OPM Cinemas, TRU Stories",
    ...
    },
    {
      ...
      attributes: {
        ...
        Country: "India",
        Language: "Malayalam",
        Distribution: "Silverline Film Factory",
        Co_Productions: true,
        ProductionsCompany: "OPM Cinemas",
        Sound_MIx: "Dolby Digital",
        Aspect_Ratio: "2.39:1",
    ...
    },
    {
      ...
      attributes: {
        ...
        genere1: "Drama",
        genere2: "Comedy",
        summary: "Bheeman, a young man, faces several challenges while trying to widen a narrow road in his locality. However, he remains determined to complete the task despite the obstacles.",
        FIlmContent: "Bheeman, a young man, faces several challenges while trying to widen a narrow road in his locality. However, he remains determined to complete the task despite the obstacles.",
        Rating: "7.2",
        RunTime: "2h 10min",
        ReleaseDate: "2021-12-03",
        Country: "India", 
        Language: "Malayalam",
        Distribution: "Aashirvad Cinemas",
        Co_Productions: true,
        ProductionsCompany: "OPM Cinemas",
        Sound_MIx: "Dolby Digital",
        Aspect_Ratio: "2.39:1",
